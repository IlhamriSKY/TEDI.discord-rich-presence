...
idle timeout as a final backstop.
...
| macOS | Quarantine xattr; helper may refuse to start. | `xattr -dr com.apple.quarantine ~/Library/Application\ Support/id.ilhamrisky.tedi/extensions/tedi.discord-rich-presence/sidecar` |
...
chmod +x ../sidecar/<platform>-<arch>/tedi-discord-helper
cd ..
